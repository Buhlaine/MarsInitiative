...
public class followplayer : MonoBehaviour {
	...
	bool whichSide(float location){
		if(location>Screen.width/2)
		{
			return side = true;
		}
		else
	...
	void OnGUI()
	{
		...
		xpos2 = (this.renderer.bounds.size.y)*0.75f;
		Vector3 headpos = (new Vector3 (0, xpos2, 0)) + (this.transform.position);
